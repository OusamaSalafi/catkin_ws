...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'irobot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/osaka/catkin_ws/install/${idir}'.  Ask the maintainer 'osaka <osaka@todo.todo>' to fix it.")
    endif()
