...
"""autogenerated by genpy from mrpt_msgs/NodeIDWithLaserScan.msg. Do not edit."""
import sys
...
class NodeIDWithLaserScan(genpy.Message):
  _md5sum = "135d436b647c8470f71b2c97722a4352"
  _type = "mrpt_msgs/NodeIDWithLaserScan"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# NodeID along with the associated LaserScan
#
...
string frame_id
"""
  __slots__ = ['nodeID','scan']
  _slot_types = ['uint64','sensor_msgs/LaserScan']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NodeIDWithLaserScan, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_Q3I().pack(_x.nodeID, _x.scan.header.seq, _x.scan.header.stamp.secs, _x.scan.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.nodeID, _x.scan.header.seq, _x.scan.header.stamp.secs, _x.scan.header.stamp.nsecs,) = _get_struct_Q3I().unpack(str[start:end])
      start = end
      end += 4
