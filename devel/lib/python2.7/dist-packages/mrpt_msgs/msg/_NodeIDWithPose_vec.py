...
"""autogenerated by genpy from mrpt_msgs/NodeIDWithPose_vec.msg. Do not edit."""
import sys
...
class NodeIDWithPose_vec(genpy.Message):
  _md5sum = "f30000109eab9cc7bc6b44c3e86d9fac"
  _type = "mrpt_msgs/NodeIDWithPose_vec"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Vector of NodeIDWithPose msgs
...
"""
  __slots__ = ['vec']
  _slot_types = ['mrpt_msgs/NodeIDWithPose[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NodeIDWithPose_vec, self).__init__(*args, **kwds)
